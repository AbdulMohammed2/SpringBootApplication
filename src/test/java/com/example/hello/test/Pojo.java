...
public class Pojo {
    ...
    private Map<String, Map<String,String>> mysettings = new HashMap<String, Map<String,String>>();
    ...
    public Map<String, Map<String,String>> getMysettings() {
    	System.out.println("mysettings is : " + this.mysettings);
